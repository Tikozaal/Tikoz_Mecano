    ...
    Events = {
        onSelected = function(self, _, btn, PMenu, menuData, result)
            ...
            elseif btn.name == "~b~Benny's ~s~personnalisé" then
                ...
                TriggerServerEvent('Tikoz:MecanoMsgPerso', msgpersomecano)
            ...
            if ESX.PlayerData.job.grade_name == 'boss' and ESX.PlayerData.job.name == "mechanic" then
            ...
            elseif btn.name == "Promouvoir" then
                if ESX.PlayerData.job.grade_name == 'boss' then
                    ...
                    if Tikozaal.closestPlayer == -1 or Tikozaal.closestDistance > 3.0 then
                        ...
                        TriggerServerEvent('Tikoz:PromotionMecano', GetPlayerServerId(Tikozaal.closestPlayer))
                    end
                else
                    ESX.ShowNotification('Vous n\'avez pas les ~r~droits~w~')
                end
...
RegisterNetEvent('Tikoz:alertmeca')
AddEventHandler('Tikoz:alertmeca', function()
    ...
    Events = {
        onSelected = function(self, _, btn, PMenu, menuData, result)
            ...
            if btn.name == "Appelé un mécano" then
                TriggerServerEvent('Tikoz:AlertMecano')
                CloseMenu()
